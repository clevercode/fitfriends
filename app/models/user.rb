class User < ActiveRecord::Base
  ...
  def percentage_lost
    current_weight = self.current_weight || BigDecimal.new('0')
    goal_weight = self.goal_weight || BigDecimal.new('0')
    start_weight = self.start_weight || BigDecimal.new('0')
    kilos_lost = start_weight - current_weight
    kilos_to_lose = start_weight - goal_weight
